...
const Register = () => {
    ...
    const {nombre, email, contrasenia, fechaNacimiento, rol} = inputs;
    ...
    const onSubmit = async(e) => {
        e.preventDefault();
        if (nombre !== '' && email !== '' && contrasenia !== '' && fechaNacimiento !== '' && rol !== ''){
            const Usuario = {
                nombre,
                email,
                contrasenia,
            ...
            setLoading(true)
            await axios
            .post('http://localhost:4000/api/usuarios/register', Usuario)
            .then (({data}) => {
                setMensaje(data.mensaje);
                setInputs({nombre:  "", email:  "", contrasenia:  "", fechaNacimiento:"", rol:""});
                setTimeout(() => {
                    setMensaje('');
                    navigate('/login');
                    setLoading(false);
    ...
    <div className={styles.formContainer}>
        <h3>Bienvenido a la pagina</h3>
            <p>
                <Link to={`/welcome/${localStorage.getItem('userId')}`}>EcuMovie</Link>
            </p>
        <h2>De Registro!</h2>
            ...
            <div className={styles.menu}>
                <div className={styles.left}>
                    ...
                    >
                        ...
                        <option value='Usuario grupo cineasta'>Grupo Cineasta</option>
                        <option value='Usuario cineasta famoso'>Cineasta Famoso</option>
